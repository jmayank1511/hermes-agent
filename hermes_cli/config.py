...
DEFAULT_CONFIG = {
    ...
    # Gemini 5000, Edge 5000, Mistral 4000, NVIDIA 5000, NeuTTS/KittenTTS 2000).
    "tts": {
        "provider": "edge",  # "edge" (free) | "elevenlabs" (premium) | "openai" | "xai" | "minimax" | "mistral" | "gemini" | "nvidia" | "neutts" (local)
        "edge": {
        ...
        "nvidia": {
            "function_id": "877104f7-e885-42b9-8de8-f6e4c6303969",  # Magpie TTS hosted NVCF function
    ...
    "stt": {
        "enabled": True,
        "provider": "local",  # "local" (free, faster-whisper) | "groq" | "openai" (Whisper API) | "mistral" (Voxtral Transcribe) | "xai" | "nvidia"
        "local": {
        ...
        "nvidia": {
            "function_id": "d3fe9151-442b-4204-a70d-5fcc597fd610",  # Parakeet TDT hosted NVCF function
